...
function _applyViewport() {
  ...
  /* Open: 380ms ease-in-out — bar rises gently with keyboard.
     Close: 480ms — slow, silky smooth settle back to position, zero bounce. */
...
(function _chatbarEntrance() {
  ...
  requestAnimationFrame(() => {
    requestAnimationFrame(() => {
      chatbarWrap.style.transition = 'transform 0.52s cubic-bezier(0.22, 1, 0.36, 1)';
