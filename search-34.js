...
function appendBotActions(msgEl, fullText) {
  ...
  const actions = [
    { key: 'copy',    label: 'Copy',    icon: 'ph-copy' },
    { key: 'retry',   label: 'Retry',   icon: 'ph-arrow-counter-clockwise' },
    { key: 'like',    label: 'Like',    icon: 'ph-thumbs-up' },
    { key: 'dislike', label: 'Dislike', icon: 'ph-thumbs-down' },
    { key: 'refresh', label: 'Refresh', icon: 'ph-arrow-clockwise' }
  ];
