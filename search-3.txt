...
function _applyViewport() {
  ...
  /* Open: 380ms ease-in-out — bar rises gently with keyboard, not abruptly.
     Close: 280ms ease-out — settles down softly, no bounce. */
  chatbarWrap.style.transition = _keyboardOpen
    ? 'transform 0.38s cubic-bezier(0.4, 0, 0.2, 1)'
    : 'transform 0.28s cubic-bezier(0.0, 0.0, 0.2, 1)';
