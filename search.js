...
function appendBotActions(msgEl, fullText) {
  ...
  const actions = [
    { key: 'copy',    label: 'Copy',    icon: 'ti-copy' },
    { key: 'retry',   label: 'Retry',   icon: 'ti-rotate' },
    { key: 'like',    label: 'Like',    icon: 'ti-thumb-up' },
    { key: 'dislike', label: 'Dislike', icon: 'ti-thumb-down' },
    { key: 'refresh', label: 'Refresh', icon: 'ti-refresh' }
  ];
