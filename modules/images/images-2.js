...
(function () {
  ...
  /* ─── Category chips data ────────────────────────────────────── */
  const CATS = [
    'Nature', 'Architecture', 'Animals', 'Travel', 'Technology',
    'People', 'Food', 'Art', 'Cars', 'Fashion', 'Space',
    'Mountains', 'Ocean', 'City', 'Forest', 'Sport',
    'Music', 'Flowers', 'Interior', 'Fitness',
  ];
  ...
  function _showEmptyState(pc) {
    ...
    const chips = CATS.map(c => `
      <button class="img-es-chip" data-q="${c}">${c}</button>`).join('');
