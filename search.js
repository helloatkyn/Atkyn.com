...
let _cleanupRafId = 0;
let _prevOffset   = -1;
let _stableKbH    = 0;   /* last "settled" keyboard height — avoids micro-jitter */
...
function _applyViewport() {
  ...
  /* Smooth transition both directions — 300ms matches Android keyboard speed.
     No abrupt jump on open, no snap on close, no bounce. */
  chatbarWrap.style.transition = 'transform 0.30s cubic-bezier(0.4, 0, 0.2, 1)';
