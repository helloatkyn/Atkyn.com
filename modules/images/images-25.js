(function () {
  ...
  function _buildTile(data) {
    ...
    // visibility:hidden hides the image (and broken-icon) while keeping it in the
    ...
    image.onerror = function () {
      ...
      // Collapsing paddingBottom first ensures the spacer contributes zero height
      // before the tile node is removed, so the masonry never sees a phantom gap.
