...
Return [SEARCH] only if the user explicitly asks to search the web, look something up online, browse the internet, or find online information, or if their intent clearly indicates they want information retrieved from the web or an external online source. Return [NO_SEARCH] for all general knowledge, coding, math, writing, science, finance, or normal conversation. When uncertain, always return [NO_SEARCH]. Your entire response must be exactly [SEARCH] or [NO_SEARCH] and nothing else.`;
