...
function appendBotActions(msgEl, fullText) {
  ...
  const actions = [
    { key: 'copy',    label: 'Copy',    icon: 'content_copy' },
    { key: 'retry',   label: 'Retry',   icon: 'refresh' },
    { key: 'like',    label: 'Like',    icon: 'thumb_up' },
    { key: 'dislike', label: 'Dislike', icon: 'thumb_down' },
    { key: 'refresh', label: 'Refresh', icon: 'autorenew' }
  ];
